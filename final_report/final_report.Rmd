...
img_entry_time <- rasterGrob(as.raster(readPNG("images/entry_time.png")),interpolate=FALSE)
img_exit_time <- rasterGrob(as.raster(readPNG("images/exit_time.png")),interpolate=FALSE)
...
img_entry_dow <- rasterGrob(as.raster(readPNG("images/entry_dow.png")),interpolate=FALSE)
img_exit_dow <- rasterGrob(as.raster(readPNG("images/exit_dow.png")),interpolate=FALSE)
...
```{r fig.width=12, fig.height=5,echo=FALSE,fig.align='center'}
img_entry <- rasterGrob(as.raster(readPNG("images/entry.png")),interpolate=FALSE)
img_exit <- rasterGrob(as.raster(readPNG("images/exit.png")),interpolate=FALSE)

gridExtra::grid.arrange(img_entry,img_exit,ncol=2)
```
```{r fig.width=12, fig.height=10,echo=FALSE,fig.align='center'}
img_entry_ww <- rasterGrob(as.raster(readPNG("images/weekday_vs_weekend_entry.png")),interpolate=FALSE)
img_exit_ww <- rasterGrob(as.raster(readPNG("images/weekday_vs_weekend_exit.png")),interpolate=FALSE)
...
img_entry_top5 <- rasterGrob(as.raster(readPNG("images/top_5_stations_entry.png")),interpolate=FALSE)
img_exit_top5 <- rasterGrob(as.raster(readPNG("images/top_5_stations_exit.png")),interpolate=FALSE)
...
img_rain_wkd <- rasterGrob(as.raster(readPNG("images/weekday_rain.png")),interpolate=FALSE)
img_rain_wkn <- rasterGrob(as.raster(readPNG("images/weekend_rain.png")),interpolate=FALSE)
...
img_crime <- rasterGrob(as.raster(readPNG("images/traffic_crime_scatter.png")),interpolate=FALSE)
...
```{r fig.width=8, fig.height=5,echo=FALSE,fig.align='center'}
img_crime_station <- rasterGrob(as.raster(readPNG("images/traffic_crime_scatter_station.png")),interpolate=FALSE)
...
```{r fig.width=8, fig.height=5,echo=FALSE,fig.align='center'}
img_taxi <- rasterGrob(as.raster(readPNG("images/taxi_to_subway.png")),interpolate=FALSE)
