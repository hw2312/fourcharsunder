mapboxgl.accessToken = 'pk.eyJ1IjoiaHcyMzEyIiwiYSI6ImNqZmhudWd1NDAxZnMzM3RmdWRsZDU2cTQifQ.cyPjdpU2kzcAq0d-K5gzuw';
...
function getGridForHour(mapElement,property, hour, isWeekend, shape_width){
  ...
  var filtered_data = mapElement.querySourceFeatures("turnstile_volume",queryObject);
  ...
  var colors = property == 'entry_volume' ? ['#ffffff', '#ffffcc','#fed976','#fd8d3c','#e04b25','#a30e11'] : ['#ffffff', '#edf9ca','#bbe8ea','#7c99bc','#456d9b','#323c8d'],
      transparency = [0.3,0.5,0.5,0.5,0.5,0.5],
      maxColor = property == 'entry_volume' ? '#560000' : '#530570',
      maxTransparency = 0.5
...
function loadSourceLayer(mapElement){
  mapElement.addSource("turnstile_volume",{
      type:"vector",
...
document.getElementById('renderbutton').addEventListener('click',function(){
  ...
  document.getElementById('renderbutton').innerText = "Click to update with new params";
